...
node {
    ...
    withEnv([
        'repo=DigitalInnovation/hlc-category-assembler-service',
        'githubTokenId=su-bloomreachmigration-secret-token',
        'vaultUrl=https://vault.platform.mnscorp.net',        
        'vaultNexusSecretDataPath=infrastructure/teams/bloomreachmigration/prod/nexus',
        'vaultk8sSecretDataPath=k8s/bloomreachmigration/apidevelopment',        						
